    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_class', models.ManyToManyField(to='Hs.SummonerClass', verbose_name='可用职业')),
                ('keyword', models.ManyToManyField(blank=True, null=True, to='Hs.Keyword', verbose_name='关键词')),
                ('race', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Hs.raceclass', verbose_name='种族')),
                ('set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Hs.setclass', verbose_name='系列')),
            ],
            options={
                'verbose_name': '卡牌',
