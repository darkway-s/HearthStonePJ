# Generated by Django 3.2.3 on 2021-06-01 06:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='卡牌名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='关键词名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=10, verbose_name='种族名称')),
            ],
            options={
                'verbose_name': '种族列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, verbose_name='所属合集')),
            ],
            options={
                'verbose_name': '合集列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ManyToManyField(blank=True, null=True, to='Hs.Card', verbose_name='收藏')),
