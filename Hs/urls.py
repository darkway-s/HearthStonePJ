...
urlpatterns = [
    ...
    path('manage/card_edit', views.card_edit, name='card_edit'),
    path('manage/card_edit_sub', views.card_edit_sub, name='card_edit_sub'),
    path('manage/card_drop', views.card_drop, name='card_drop'),
    ...
    path('manage/raceclass_edit', views.raceclass_edit, name='raceclass_edit'),
    path('manage/raceclass_edit_sub', views.raceclass_edit_sub, name='raceclass_edit_sub'),
    path('manage/raceclass_drop', views.raceclass_drop, name='raceclass_drop'),
    ...
    path('manage/setclass_edit', views.setclass_edit, name='setclass_edit'),
    path('manage/setclass_edit_sub', views.setclass_edit_sub, name='setclass_edit_sub'),
    path('manage/setclass_add', views.setclass_add, name='setclass_add'),
    path('manage/setclass_add_sub', views.setclass_add_sub, name='setclass_add_sub'),
    path('manage/setclass_drop', views.setclass_drop, name='setclass_drop'),
